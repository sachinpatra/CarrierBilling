//
//  IVChatTableViewCellRingMCReceivedEx.m
//  InstaVoice
//
...
#import "IVChatTableViewCellRingMCReceivedEx.h"
#import "IVColors.h"
#import "Macro.h"
...
@implementation IVChatTableViewCellRingMCReceivedEx
...
-(void)configureCellForChatTile:(NSMutableDictionary *)dic forRow:(int)rowValue
{
    ...
    [self.msgIndicator setImage:[UIImage imageNamed:@"ringIconDown"]];
