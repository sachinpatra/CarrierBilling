...
// commented while analysing memory leak
...
//       [[[[UIApplication sharedApplication] windows] lastObject] addSubview:self];
        ...
        //[[[[UIApplication sharedApplication] windows] objectAtIndex:0] addObject:self];
    }
...
{
    KLog1(@"Button Clicked! %ld, %ld", (long)buttonIndex, (long)[alertView tag]);
   // [self close];
}
...
- (UIView *)createContainerView
{
    ...
    UIView *dialogContainer = [[UIView alloc] initWithFrame:CGRectMake((screenSize.width - dialogSize.width) / 2, (screenSize.height - dialogSize.height) / 2, dialogSize.width, dialogSize.height - 10)];
    ...
    UIView *lineView = [[UIView alloc] initWithFrame:CGRectMake(0, dialogContainer.bounds.size.height - buttonHeight - buttonSpacerHeight + 5, dialogContainer.bounds.size.width, buttonSpacerHeight)];
    lineView.backgroundColor = [UIColor colorWithRed:198.0/255.0 green:198.0/255.0 blue:198.0/255.0 alpha:1.0f];
    [dialogContainer addSubview:lineView];
    // ^^^
    // Add the custom container if there is any
//    containerView.backgroundColor = [UIColor colorWithRed:20.0f/255 green:73.0f/255 blue:127.0f/255 alpha:1];
...
//      [closeButton setBackgroundColor:[UIColor colorWithRed:20.0f/255 green:73.0f/255 blue:127.0f/255 alpha:1]];
...
- (void)keyboardWillHide: (NSNotification *)notification
{
    ...
    [UIView animateWithDuration:0.2f delay:0.0 options:UIViewAnimationOptionTransitionNone
					 animations:^{
                         dialogView.frame = CGRectMake((screenSize.width - dialogSize.width) / 2, (screenSize.height - dialogSize.height) / 2, dialogSize.width, dialogSize.height - 13);
					 }
					 completion:nil
	 ];
}
