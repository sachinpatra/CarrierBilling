...
//#define kGradientBottomColor [UIColor colorWithRed:0.f green:0.f blue:0.f alpha:kBoxAlpha]
#define kGradientBottomColor [UIColor colorWithRed:0.f green:0.f blue:0.f alpha:kBoxAlpha]

//top color white value in gradient bg
//#define kGradientTopColor [UIColor colorWithRed:0.f green:0.f blue:0.f alpha:.2]
#define kGradientTopColor [UIColor colorWithRed:0.f green:0.f blue:0.f alpha:.3]
