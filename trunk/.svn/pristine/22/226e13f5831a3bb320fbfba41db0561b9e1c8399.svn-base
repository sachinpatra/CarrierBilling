...
@objc public protocol ReachMeRatingViewDelegate {
    @objc optional func reachMeRatingView(_ ratingView: ReachMeRatingView, didUpdate rating: Double)
    @objc optional func reachMeRatingView(_ ratingView: ReachMeRatingView, isUpdating rating: Double)
}

@IBDesignable
@objcMembers
open class ReachMeRatingView: UIView {
    
    // MARK: Properties
    
    open weak var delegate: ReachMeRatingViewDelegate?
    ...
    private func updateLocation(_ touch: UITouch) {
        ...
        // Update delegate
        delegate?.reachMeRatingView?(self, isUpdating: rating)
    }
    ...
    override open func layoutSubviews() {
        ...
        let maxImageWidth = min(minImageSize.width, desiredImageWidth)
        let maxImageHeight = min(minImageSize.height, frame.size.height)
    ...
    override open func touchesEnded(_ touches: Set<UITouch>, with event: UIEvent?) {
        // Update delegate
        delegate?.reachMeRatingView?(self, didUpdate: rating)
    }
