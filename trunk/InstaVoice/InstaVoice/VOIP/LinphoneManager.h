...
//CMP #import "IASKAppSettingsViewController.h"
//#import "FastAddressBook.h"
//CMP #import "InAppProductsManager.h"
...
extern NSString *const kLinphoneNetworkReachable;
...
@private
    ...
    NSMutableArray* calledNumber; //Array of objects. {<callid> = <dic>,...}
    ...
    NSMutableArray* _voipCallBlockedContacts;
    ...
    NSInteger bitRate;
    NSInteger clockRate;
    LinphoneCallLog* thisCallLog;
    NSTimer* callStatsTimer;
    NSString* bwUsage;
    NSInteger userRating;
    NSString* reasonsSelected;//Comma separated int values
    NSString* userComments;
    BOOL _showUserRating;
    CallLogMgr* clMgr;
    NSString* sToNumber;
    UIAlertController* acMicrophone;
     
    NSString* _callType;
    NSString* _fromNumber;//for OBD call
    BOOL _isReachMeHdrPresent;
    UIAlertController* callOptionsController;
...
/*
-(void)setVoipCallBlockedContacts:(NSArray*)blockedContacts;
-(NSArray*)getVoipCallBlockedContacts;
 */
//
...
//CMP @property(readonly) InAppProductsManager *iapManager;
...
@property (atomic) NSMutableArray* voipCallBlockedContacts;
@property (atomic) BOOL showUserRating;
@property (atomic) NSString* callType;
@property (atomic) BOOL isReachMeHdrPresent;
