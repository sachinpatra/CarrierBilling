//
//  IVChatTableViewCellReachMeCallReceivedEx.m
//  InstaVoice
//
...
#import "IVChatTableViewCellReachMeCallReceivedEx.h"
#import "IVColors.h"
#import "Macro.h"
...
@implementation IVChatTableViewCellReachMeCallReceivedEx
...
-(void)configureCellForChatTile:(NSMutableDictionary *)dic forRow:(int)rowValue
{
    ...
    self.messageContentLabel.text = @"Answered";
