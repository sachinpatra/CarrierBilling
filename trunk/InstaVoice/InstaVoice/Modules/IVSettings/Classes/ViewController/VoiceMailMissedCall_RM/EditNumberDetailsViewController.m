...
- (void)viewDidLoad {
    ...
    if (self.isReachMeNumber) {
        self.carrierNameLabel.text = @"ReachMe Number";
    }else{
...
- (void)viewWillAppear:(BOOL)animated
{
    ...
    if (self.isReachMeNumber) {
        self.infoLabel.text = @"ReachMe number is a SIM-less number that gives you the ability to receive calls over WiFi or mobile data.";
    }else{
        self.infoLabel.text = @"Please make sure selected carrier is correct for the above number. If you’ve ported to a new carrier, select the new carrier and reactivate your prefered usage mode.";
    }
