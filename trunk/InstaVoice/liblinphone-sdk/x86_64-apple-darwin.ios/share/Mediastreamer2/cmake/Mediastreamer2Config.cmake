...
if(LINPHONE_BUILDER_GROUP_EXTERNAL_SOURCE_PATH_BUILDERS)
	...
	list(INSERT MEDIASTREAMER2_INCLUDE_DIRS 0 "/Users/pandian/Documents/ReachMe/linphone-iphone/liblinphone-sdk/x86_64-apple-darwin.ios/include")
endif()
list(REMOVE_DUPLICATES MEDIASTREAMER2_INCLUDE_DIRS)

set(MEDIASTREAMER2_CPPFLAGS -DBZRTP_STATIC;-DBCG729_STATIC)
set(MEDIASTREAMER2_LDFLAGS "-framework CoreFoundation -framework AudioToolbox -framework CoreAudio -framework Foundation -framework QuartzCore -framework OpenGLES -framework UIKit -framework AVFoundation")
