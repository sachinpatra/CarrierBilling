...
if(LINPHONE_BUILDER_GROUP_EXTERNAL_SOURCE_PATH_BUILDERS)
	...
	list(INSERT LINPHONE_INCLUDE_DIRS 0 "/Users/pandian/Documents/ReachMe/linphone-iphone/liblinphone-sdk/x86_64-apple-darwin.ios/include")
endif()
list(REMOVE_DUPLICATES LINPHONE_INCLUDE_DIRS)

set(LINPHONE_CPPFLAGS -DBELLESIP_STATIC;-DBZRTP_STATIC;-DBCG729_STATIC)
set(LINPHONE_LDFLAGS "-framework Foundation -framework CoreFoundation -framework CFNetwork -framework UIKit -framework CoreFoundation -framework AudioToolbox -framework CoreAudio -framework Foundation -framework QuartzCore -framework OpenGLES -framework UIKit -framework AVFoundation")
